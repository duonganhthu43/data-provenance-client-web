...
export default function* sagas() {
	yield takeLatest("GET_RESOURCES_OF_CURRENT_USER_REQUEST", getResourcesOfCurrentUser);
}

function* getResourcesOfCurrentUser(action) {
	try {
		yield put({ type: "GET_RESOURCES_OF_CURRENT_USER_LOADING" });
